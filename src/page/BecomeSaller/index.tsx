...
export default function BecomeSaller() {
  ...
  const coverImgChangHandler = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.value !== "") {
      const imgReader = new FileReader();
      imgReader.onload = (event) => {
        setCoverImg(event.target!.result as string);
      };
      imgReader.readAsDataURL(e.target.files![0]);
    }
  };
                  ...
                  <div className="update-profile w-full mb-9">
                    ...
                    <div className="flex xl:justify-center justify-start">
                      <div className="relative">
                        <img
                          src={
                            profileImg || `/assets/images/edit-profileimg.jpg`
                          }
                          alt=""
                  ...
                  <div className="update-cover w-full">
                    ...
                    <div className="flex justify-center">
                      <div className="w-full relative">
                        <img
                          src={coverImg || `/assets/images/edit-coverimg.jpg`}
                          alt=""
