...
export default function OrderDetail(/*props: donHang*/) {
    return (
        <div className="container-x mx-auto">
            <div className=" w-full flex justify-between">
                <span className="py-6 flex-row gap-10 h-auto">
                    <h3 className="font-semibold text-qgray text-[20px] mb-3">ĐƠN HÀNG</h3>
                    <h3 className="font-semibold text-qblacktext">#{donHangE.data.orderCode}</h3>
                </span>
                <span className="py-6 flex-row gap-10 h-auto">
                    <h3 className="font-semibold text-qgray text-[20px] text-right mb-3">Ngày đặt</h3>
                    <h3 className="font-semibold text-qblacktext text-right">#{donHangE.timestamp}</h3>
                </span>
            </div>
            <div className="py-[40px] rounded-[10px]">
                <h3 className="font-semibold text-qgray text-[16px] mb-3">Trạng thái</h3>
            ...
            <div className="w-full lg:flex lg:space-x-[30px]">
              ...
              <div className="flex-1">
                ...
                <div className="w-full px-10 py-[30px] border border-[#EDEDED]">
                  ...
                  <div className="mt-[30px]">
                    <div className=" flex justify-between mb-5">
                      <p className="text-2xl font-medium text-qblack">Tổng giá trị hóa đơn</p>
