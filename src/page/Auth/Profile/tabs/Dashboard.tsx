...
export default function Dashboard() {
  ...
  const userOrders = useQuery({
    ...
    queryFn: () =>
      getUserOrders({
        userLogin:
          currentUser && currentUser.userLogin ? currentUser.userLogin : null,
      }),
                  ...
                  {userOrders.data?.map((order: OrderProps) => (
                    ...
                    >
                      ...
                      <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                        ...
                        <dd className="mt-1.5 text-sm font-semibold text-gray-700 dark:text-white">
                      ...
                      <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                        ...
                        >
                          {order && order.paymentSuccess
                            ? "Đã thanh toán"
                            : "Chưa thanh toán"}
                        </dd>
                      </dl>

                      <dl className="w-fit grid sm:grid-cols-2 lg:items-center lg:justify-end gap-2">
                        <Link
                          to={`/order-detail/${order.orderCode}`}
                          className="w-full text-xs inline-flex justify-center rounded-lg  border border-gray-200 bg-white px-3 py-2 font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 lg:w-auto"
                        >
                          Chi tiết
                        </Link>
                        <button
                          type="button"
                          className="w-full text-xs rounded-lg border border-red-700 px-3 py-2 text-center font-medium text-red-700 hover:bg-red-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-red-300 dark:border-red-500 dark:text-red-500 dark:hover:bg-red-600 dark:hover:text-white dark:focus:ring-red-900 lg:w-auto"
                        >
                          Hủy đơn
                        </button>
                      </dl>
