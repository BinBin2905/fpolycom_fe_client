            ...
            <thead className="text-[15px] text-gray-700 uppercase bg-gray-100">
              ...
              <tbody>
                  ...
                  <tr className="bg-white dark:bg-gray-800 border-b-gray-100 border-b-[1px] h-[140px] text-[13px]">
                        ...
                        <td scope="row" className="font-medium text-gray-900 whitespace-nowrap text-left">
                          <label htmlFor={`${item?.productDetailCode}`} className="flex space-x-4 items-center">
                        ...
                        <td>
                            ...
                            <p className="flex-1 text-[15px] font-medium">
                              {`${(item.price - (item.price * item.percentDecrease / 100)).toLocaleString("en-US")} ₫`}
                            </p>
                            </div>
                        </td>
